...
$states = loadRealData('C:\xampp\htdocs\php\project\DOR.csv');
if (!file_exists('C:\xampp\htdocs\php\project\DOR.csv')) {
...
$schoolTypeData = loadSchoolTypeData('C:\xampp\htdocs\php\project\dataset.csv');
if (!file_exists('C:\xampp\htdocs\php\project\dataset.csv')) {
    die('CSV file not found.');
}
...
<body class="bg-gray-300 font-sans">
    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div class="flex justify-center mb-12">
    <a href="contribute.php" class="bg-accent hover:bg-tertiary text-white font-medium py-2 px-6 rounded">
    Contribute
</a>
</div>
